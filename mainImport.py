...
def Player(spawnCoordinates:Position, board:Board):
    return PlayerClass(spawnCoordinates, board, [Bloc, MonsterClass], lambda object, direction, HTH, damages: HitStraightLine(object, direction, HTH, damages), convert_px_in_number, MousePosition)
