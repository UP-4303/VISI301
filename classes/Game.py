...
class Game:
    ...
    def update(self, screen):
        ...
        money_player_text = font_small.render("Money :" + str(self.player.money), 1, (255, 255, 255))  # create texte money
        ...
        description_currentMonster_text = font_small.render("Description :" + str(self.current_monster.description), 1, (255, 255, 255))  # create texte description
        ...
        screen.blit(health_player_text, (650, 460))  # show the health at the tuple position

        # Create player health bar
        bar2_back_position = [750, 470, 180, 7]  # x, y, w, h
        bar2_position = [750, 470, (self.current_monster.healthPoints / self.current_monster.maxHealthPoints) * 180, 7]  # x, y, w, h
